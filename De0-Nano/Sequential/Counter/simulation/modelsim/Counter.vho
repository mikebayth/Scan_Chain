...
ENTITY 	Counter IS
	...
	dummy : BUFFER std_logic_vector(3 DOWNTO 0)
	);
END Counter;
...
SIGNAL \dummy[0]~output_o\ : std_logic;
SIGNAL \dummy[1]~output_o\ : std_logic;
SIGNAL \dummy[2]~output_o\ : std_logic;
SIGNAL \dummy[3]~output_o\ : std_logic;
...
SIGNAL \SC|In_Reg|L2[1]~feeder_combout\ : std_logic;
...
\dummy[0]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\dummy[1]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\dummy[2]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\dummy[3]~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
PORT MAP (
	datab => \TRST~input_o\,
	datac => \SC|next_state.s_idle_162~combout\,
...
PORT MAP (
	dataa => \TRST~input_o\,
	datab => \SC|next_state.s_capture_148~combout\,
...
PORT MAP (
	...
	datac => \TRST~input_o\,
	datad => \SC|current_state.s_update~q\,
...
\SC|In_Reg|L2[1]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \SC|In_Reg|L2[1]~feeder_combout\ = \SC|In_Reg|L2~0_combout\
...
-- pragma translate_on
PORT MAP (
	datad => \SC|In_Reg|L2~0_combout\,
	combout => \SC|In_Reg|L2[1]~feeder_combout\);
...
PORT MAP (
	clk => \TCLK~input_o\,
	d => \SC|In_Reg|L2[1]~feeder_combout\,
	ena => \SC|In_Reg|L2~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \SC|In_Reg|L2\(1));
...
ww_dummy(0) <= \dummy[0]~output_o\;

ww_dummy(1) <= \dummy[1]~output_o\;

ww_dummy(2) <= \dummy[2]~output_o\;

ww_dummy(3) <= \dummy[3]~output_o\;
END structure;
